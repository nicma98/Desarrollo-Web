      ...
      $.ajax(
        {
          ...
          success: (data) =>{
            ...
            if (datos.msg=="OK") {
              this.poblarCalendario(datos.eventos);
            }else {
              alert('No encontramos eventos en tu calendario')
            }
          },
          error: function(){
      ...
      $.ajax({
        ...
        success: (data) =>{
          ...
          if (datos.msg == "OK") {
            ...
            alert('Ha ocurrido un error creando el evento')
          }
        },
        error: function(){
          alert("error en la comunicación con el servidor");
        ...
        $.ajax({
          ...
          success: (data) =>{
            ...
            if (datos.msg=="OK") {
              ...
              alert('Ha ocurrido un problema actualizando el evento')
            }
          },
          error: function(){
            alert("Error en la comunicación con el servidor");
